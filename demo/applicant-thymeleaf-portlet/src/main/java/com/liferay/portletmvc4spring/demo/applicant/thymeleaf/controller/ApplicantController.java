...
import com.liferay.portletmvc4spring.demo.applicant.thymeleaf.dto.Applicant;
import com.liferay.portletmvc4spring.demo.applicant.thymeleaf.dto.Attachment;
import com.liferay.portletmvc4spring.demo.applicant.thymeleaf.dto.City;
import com.liferay.portletmvc4spring.demo.applicant.thymeleaf.dto.TransientUpload;
...
public class ApplicantController {
	...
	@RenderMapping
	public String prepareView(PortletRequest portletRequest, MimeResponse mimeResponse, Model model,
		...
		// Thymeleaf
		model.addAttribute("autoFillResourceURL", ControllerUtil.createResourceURL(mimeResponse, "autoFill"));
		model.addAttribute("contextPath", portletRequest.getContextPath());
		model.addAttribute("deleteFileResourceURL", ControllerUtil.createResourceURL(mimeResponse, "deleteFile"));
		model.addAttribute("mainFormActionURL", mimeResponse.createActionURL());
		model.addAttribute("namespace", mimeResponse.getNamespace());
		model.addAttribute("viewTermsResourceURL", ControllerUtil.createResourceURL(mimeResponse, "viewTerms"));
		model.addAttribute("uploadFilesResourceURL", ControllerUtil.createResourceURL(mimeResponse, "uploadFiles"));
	...
	private Applicant _getApplicantModelAttribute(PortletSession portletSession) {
		...
		return new Applicant(attachments);
	}
