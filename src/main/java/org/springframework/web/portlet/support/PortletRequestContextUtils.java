...
import org.springframework.web.portlet.PortletLocaleContextResolver;
...
public abstract class PortletRequestContextUtils {
	 ...
	 * PortletLocaleResolver bound to the request by the DispatcherServlet
	 * (if available), falling back to the request's accept-header Locale.
	 * <p>This method serves as a straightforward alternative to the standard
	 * Servlet {@link PortletRequest#getLocale()} method,
	 ...
	 * PortletLocaleResolver or from the plain request itself
	 ...
	 * differs in terms of its fallback to the system time zone if the PortletLocaleResolver
