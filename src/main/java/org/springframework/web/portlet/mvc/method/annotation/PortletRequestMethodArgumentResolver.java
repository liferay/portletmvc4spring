...
import org.springframework.web.portlet.support.PortletRequestContextUtils;
 ...
 * <ul>
 * <li>{@link WebRequest}
 * <li>{@link PortletRequest}
 * <li>{@link MultipartRequest}
 * <li>{@link PortletSession}
 * <li>{@link Principal}
 * <li>{@link InputStream}
 * <li>{@link Reader}
 * <li>{@link Locale}
...
public class PortletRequestMethodArgumentResolver implements HandlerMethodArgumentResolver {
	...
	public boolean supportsParameter(MethodParameter parameter) {
		...
		return (WebRequest.class.isAssignableFrom(paramType) ||
				Event.class.isAssignableFrom(paramType) ||
				MultipartRequest.class.isAssignableFrom(paramType) ||
				PortalContext.class.isAssignableFrom(paramType) ||
				PortletMode.class.isAssignableFrom(paramType) ||
				PortletPreferences.class.isAssignableFrom(paramType) ||
				PortletRequest.class.isAssignableFrom(paramType) ||
				PortletSession.class.isAssignableFrom(paramType) ||
				Principal.class.isAssignableFrom(paramType) ||
				InputStream.class.isAssignableFrom(paramType) ||
				Reader.class.isAssignableFrom(paramType) ||
				Locale.class == paramType ||
				TimeZone.class == paramType ||
				WindowState.class == paramType ||
