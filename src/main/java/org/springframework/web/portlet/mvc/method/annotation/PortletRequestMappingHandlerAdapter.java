...
import org.springframework.web.portlet.bind.annotation.support.HandlerMethodResolver;
import org.springframework.web.portlet.context.PortletWebRequest;
import org.springframework.web.portlet.mvc.annotation.PortletAnnotationMappingUtils;
import org.springframework.web.portlet.mvc.method.AbstractPortletHandlerMethodAdapter;
...
/**
 * Extension of {@link AbstractPortletHandlerMethodAdapter} that supports
 * {@code HandlerMethods} annotated with {@link org.springframework.web.portlet.bind.annotation.ActionMapping},
 * {@link org.springframework.web.portlet.bind.annotation.EventMapping},
 * {@link org.springframework.web.portlet.bind.annotation.RenderMapping}, or
 * {@link org.springframework.web.portlet.bind.annotation.ResourceMapping}.
 *
 ...
 */
public class PortletRequestMappingHandlerAdapter extends AbstractPortletHandlerMethodAdapter implements
	BeanFactoryAware, InitializingBean {

	public static final String IMPLICIT_MODEL_SESSION_ATTRIBUTE =
		PortletRequestMappingHandlerAdapter.class.getName() + ".IMPLICIT_MODEL";
	...
	@Override
	protected void handleActionInternal(
	 ...
	 * <p>The default implementation creates a PortletRequestDataBinderFactory.
	...
	protected ModelAndView doHandle(PortletRequest request, PortletResponse response, HandlerMethod handlerMethod) throws Exception {
		...
		if (response instanceof MimeResponse) {
			...
			if (handlerMethod.getClass().getAnnotation(SessionAttributes.class) != null) {
	...
	private ModelAndView invokeHandlerMethod(
		PortletRequest request, PortletResponse response, HandlerMethod handlerMethod, ModelMap implicitModel)
		throws Exception {
