 ...
 * org.springframework.beans.factory.xml.XmlBeanDefinitionReader}. This is essentially the equivalent of {@link
 * org.springframework.context.support.AbstractXmlApplicationContext} for a portlet environment.
 *
 * <p>By default, the configuration will be taken from "/WEB-INF/applicationContext.xml" for the root context, and
 * "/WEB-INF/test-portlet.xml" for a context with the namespace "test-portlet" (like for a DispatcherPortlet instance
 * with the portlet-name "test").
 *
 * <p>The config location defaults can be overridden via the "contextConfigLocation" portlet init-param of {@link
 * com.liferay.portletmvc4spring.FrameworkPortlet}. Config locations can either denote concrete files like
 * "/WEB-INF/context.xml" or Ant-style patterns like "/WEB-INF/*-context.xml" (see {@link
 ...
 *
 * <p><b>For a Portlet-based context that reads in a different bean definition format, create an analogous subclass of
 * {@link AbstractRefreshablePortletApplicationContext}.</b> Such a context implementation can be specified as
 ...
 * @see     com.liferay.portletmvc4spring.FrameworkPortlet#initPortletApplicationContext
 */
public class XmlPortletApplicationContext extends AbstractRefreshablePortletApplicationContext {
	...
	/**
	 * Initialize the bean definition reader used for loading the bean definitions of this context. Default
