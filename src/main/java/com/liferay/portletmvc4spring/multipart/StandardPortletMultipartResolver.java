 ...
 * To be added as "portletMultipartResolver" bean to a Spring DispatcherServlet
 * context, without any extra configuration at the bean level (see below).
 *
 * <p><b>Note:</b> In order to use Portlet 3.0 based multipart parsing,
 * you need to mark the affected servlet with a "multipart-config" section in
 * {@code portlet.xml}, or (in case of a custom portlet class) possibly with a
 * {@link javax.portlet.annotations.Multipart} annotation on your portlet class.
 * Configuration settings such as maximum sizes or storage locations need to be
 * applied at that portlet registration level.
 *
...
public class StandardPortletMultipartResolver implements PortletMultipartResolver {
	...
	public MultipartActionRequest resolveMultipart(
		ActionRequest actionRequest) throws MultipartException {
	...
	@Override
	public MultipartResourceRequest resolveMultipart(
		ResourceRequest resourceRequest) throws MultipartException {
	...
	private static class StandardPortletMultipartFile implements MultipartFile,
		Serializable  {
