...
public abstract class AbstractListableBeanFactoryTests extends AbstractBeanFactoryTests {
	...
	/**
	 * Check that count refers to factory class, not bean class. (We don't know what type factories may return, and it
	...
	protected void assertTestBeanCount(int count) {
		...
		assertTrue("We should have " + count + " beans for class com.liferay.spring.tests.sample.beans.TestBean, not " +
		...
		assertTrue("We should have " + countIncludingFactoryBeans +
			" beans for class com.liferay.spring.tests.sample.beans.TestBean, not " + names.length,
