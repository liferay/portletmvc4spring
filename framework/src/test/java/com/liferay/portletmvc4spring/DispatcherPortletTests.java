...
import com.liferay.portletmvc4spring.context.PortletConfigAwareBean;
...
public class DispatcherPortletTests {
	...
	public void dispatcherPortletContextRefresh() throws PortletException {
		MockPortletContext portletContext = new MockPortletContext("com/liferay/portletmvc4spring/context");
		DispatcherPortlet portlet = new DispatcherPortlet();

		portlet.init(new MockPortletConfig(portletContext, "empty"));

		PortletContextAwareBean contextBean = (PortletContextAwareBean) portlet.getPortletApplicationContext().getBean(
				"portletContextAwareBean");
		PortletConfigAwareBean configBean = (PortletConfigAwareBean) portlet.getPortletApplicationContext().getBean(
				"portletConfigAwareBean");
		...
		PortletContextAwareBean contextBean2 = (PortletContextAwareBean) portlet.getPortletApplicationContext().getBean(
				"portletContextAwareBean");
		PortletConfigAwareBean configBean2 = (PortletConfigAwareBean) portlet.getPortletApplicationContext().getBean(
				"portletConfigAwareBean");
		assertSame(portletContext, contextBean.getPortletContext());
		assertSame(portlet.getPortletConfig(), configBean.getPortletConfig());
	...
	public void dispatcherPortlets() {
		...
		assertTrue("Correct attribute",
			(FrameworkPortlet.PORTLET_CONTEXT_PREFIX + "complex").equals(
				complexDispatcherPortlet.getPortletContextAttributeName()));
	...
	public void getMessage() {
		String message = complexDispatcherPortlet.getPortletApplicationContext().getMessage("test", null,
				Locale.ENGLISH);
	...
	public void getMessageWithArgs() {
		...
		String message = complexDispatcherPortlet.getPortletApplicationContext().getMessage("test.args", args,
				Locale.ENGLISH);
...
// expected
	...
	public void portletHandlerAdapterActionRequest() throws Exception {
		...
		ComplexPortletApplicationContext.MyPortlet myPortlet = (ComplexPortletApplicationContext.MyPortlet)
