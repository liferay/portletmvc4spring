...
public class XmlPortletApplicationContextTests extends AbstractXmlWebApplicationContextTests {
	...
	public void portletConfigAwareBean() {
		PortletConfigAwareBean bean = (PortletConfigAwareBean) this.applicationContext.getBean(
	...
	public void portletContextAwareBean() {
		PortletContextAwareBean bean = (PortletContextAwareBean) this.applicationContext.getBean(
	...
	public void withoutMessageSource() throws Exception {
		...
		pac.setConfigLocations(new String[] { "/com/liferay/portletmvc4spring/context/WEB-INF/test-portlet.xml" });
		pac.refresh();
	...
	protected ConfigurableApplicationContext createContext() throws Exception {
		...
		root.setConfigLocations(
			new String[] { "/com/liferay/portletmvc4spring/context/WEB-INF/applicationContext.xml" });
