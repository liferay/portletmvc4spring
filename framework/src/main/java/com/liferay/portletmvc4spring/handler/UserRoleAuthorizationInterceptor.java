...
/**
 * Interceptor that checks the authorization of the current user via the user's roles, as evaluated by PortletRequest's
 * isUserInRole method.
 *
 * @author  John A. Lewis
...
public class UserRoleAuthorizationInterceptor extends HandlerInterceptorAdapter {
	 ...
	 *
	 * <p>This method can be overridden to write a custom message, forward or redirect to some error page or login page,
	 * or throw a PortletException.
	 *
