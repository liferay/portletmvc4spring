...
/**
 * {@link com.liferay.portletmvc4spring.HandlerExceptionResolver} implementation that allows for mapping exception class
 * names to view names, either for a set of given handlers or for all handlers in the DispatcherPortlet.
 *
...
public class SimpleMappingExceptionResolver extends AbstractHandlerExceptionResolver {
	 ...
	 *
	 * <p>Follows the same matching algorithm as RuleBasedTransactionAttribute and RollbackRuleAttribute.
	 *
	...
	protected String findMatchingViewName(Properties exceptionMappings, Exception ex) {
		...
		for (Enumeration<?> names = exceptionMappings.propertyNames(); names.hasMoreElements();) {
			...
			if ((depth >= 0) &&
					((depth < deepest) ||
						((depth == deepest) && (dominantMapping != null) &&
	 ...
	 *
	 * <p>0 means ex matches exactly. Returns -1 if there's no match. Otherwise, returns depth. Lowest depth wins.
	 *
	 * <p>Follows the same algorithm as {@link org.springframework.transaction.interceptor.RollbackRuleAttribute}.
	 */
	...
	/**
	 * Return a ModelAndView for the given view name and exception. Default implementation adds the specified exception
	...
	/**
	 * Return a ModelAndView for the given request, view name and exception. Default implementation delegates to {@code
