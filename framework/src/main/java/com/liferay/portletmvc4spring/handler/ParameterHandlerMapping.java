...
/**
 * Implementation of the {@link com.liferay.portletmvc4spring.HandlerMapping} to map from a request parameter to request
 * handler beans.
 *
 ...
 *
 * <pre class="code">
   &lt;bean id="parameterHandlerMapping" class="com.liferay.portletmvc4spring.handler.ParameterHandlerMapping"&gt;
...
public class ParameterHandlerMapping extends AbstractMapBasedHandlerMapping<String> {
	...
	/**
	 * Set a Map with parameters as keys and handler beans or bean names as values. Convenient for population with bean
	 * references.
	 *
