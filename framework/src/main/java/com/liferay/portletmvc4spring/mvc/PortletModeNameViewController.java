...
/**
 * <p>Trivial controller that transforms the PortletMode to a view name. The advantage here is that the client is not
 * exposed to the concrete view technology but rather just to the controller URL; the concrete view will be determined
 * by the ViewResolver.</p>
 *
