...
/**
 * Invokes {@link RequestBodyAdvice} and {@link ResponseBodyAdvice} where each instance may be (and is most likely)
 * wrapped with {@link ControllerAdviceBean ControllerAdviceBean}.
 *
...
class RequestResponseBodyAdviceChain implements RequestBodyAdvice, ResponseBodyAdvice<Object> {
	...
	/**
	 * Create an instance from a list of objects that are either of type {@code ControllerAdviceBean} or {@code
	 * RequestBodyAdvice}.
	 */
