...
/**
 * Extension of the Portlet {@link Controller} interface that allows for handling Portlet 2.0 resource requests as well.
 * Can also be implemented by {@link AbstractController} subclasses.
 *
...
public interface ResourceAwareController {
	...
	/**
	 * Process the resource request and return a ModelAndView object which the DispatcherPortlet will render. A {@code
