...
/**
 * Parameter extraction methods, for an approach distinct from data binding, in which parameters of specific types are
 * required.
 *
 * <p>This approach is very useful for simple submissions, where binding request parameters to a command object would be
 * overkill.
 *
...
public abstract class PortletRequestUtils {
	...
	/**
	 * Get a Boolean parameter, or {@code null} if not present. Throws an exception if it the parameter value isn't a
	 * boolean.
	 *
	 * <p>Accepts "true", "on", "yes" (any case) and "1" as values for true; treats every other non-empty value as false
	 ...
	 *
	 * @throws  PortletRequestBindingException  a subclass of PortletException, so it doesn't need to be caught
	 */
	...
	/**
	 * Get a Double parameter, or {@code null} if not present. Throws an exception if it the parameter value isn't a
	 * number.
	 *
	 * @param   request  current portlet request
	 * @param   name     the name of the parameter
	...
	/**
	 * Get a Float parameter, or {@code null} if not present. Throws an exception if it the parameter value isn't a
	 * number.
	 *
	 * @param   request  current portlet request
	 * @param   name     the name of the parameter
	...
	/**
	 * Get an Integer parameter, or {@code null} if not present. Throws an exception if it the parameter value isn't a
	 * number.
	 *
	 * @param   request  current portlet request
	 * @param   name     the name of the parameter
	...
	/**
	 * Get a Long parameter, or {@code null} if not present. Throws an exception if it the parameter value isn't a
	 * number.
	 *
	 * @param   request  current portlet request
	 * @param   name     the name of the parameter
	...
	/**
	 * Get a String parameter, or {@code null} if not present. Throws an exception if it the parameter value is empty.
	 *
	 * @param   request  current portlet request
	 * @param   name     the name of the parameter
	 *
