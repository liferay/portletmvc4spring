...
/**
 * Interface to be implemented by any object that wishes to be notified of the PortletContext (typically determined by
 * the PortletApplicationContext) that it runs in.
 *
...
public interface PortletContextAware extends Aware {
	 ...
	 *
	 * <p>Invoked after population of normal bean properties but before an init callback like InitializingBean's
