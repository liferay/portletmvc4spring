 ...
 *
 * <p>This differs from traditional Spring singletons in that it exposes attributes in the PortletContext. Those
 * attributes will get destroyed whenever the entire application shuts down, which might be earlier or later than the
 * shutdown of the containing Spring ApplicationContext.
 *
 * <p>The associated destruction mechanism relies on a {@link org.springframework.web.context.ContextCleanupListener}
 * being registered in {@code web.xml}. Note that {@link org.springframework.web.context.ContextLoaderListener} includes
