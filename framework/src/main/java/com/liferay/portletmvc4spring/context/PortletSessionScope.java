...
public class PortletSessionScope extends SessionScope {
	 ...
	 *
	 * <p>This distinction is important for Portlet environments, where there are two notions of a session: "portlet
	 * scope" and "application scope". If this flag is on, objects will be put into the "application scope" session;
	 ...
	 *
	 * @param  globalSession  {@code true} in case of the global session as target; {@code false} in case of a
	 *                        component-specific session as target
	 *
	 * @see    com.liferay.portletmvc4spring.context.PortletRequestAttributes
