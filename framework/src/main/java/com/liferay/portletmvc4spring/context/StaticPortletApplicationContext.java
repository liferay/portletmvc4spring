...
/**
 * Static Portlet-based {@link org.springframework.context.ApplicationContext} implementation for testing. Not intended
 * for use in production applications.
 *
 * <p>Implements the {@link com.liferay.portletmvc4spring.context.ConfigurablePortletApplicationContext} interface to
 * allow for direct replacement of an {@link XmlPortletApplicationContext}, despite not actually supporting external
 * configuration files.
 *
 * <p>Interprets resource paths as portlet context resources, that is, as paths beneath the portlet application root.
 * Absolute paths, for example for files outside the portlet app root, can be accessed via "file:" URLs, as implemented
	...
	public void setConfigLocation(String configLocation) {
		...
		if (configLocation != null) {
			throw new UnsupportedOperationException(
				"StaticPortletApplicationContext does not support config locations");
		}
	}
