...
/**
 * Exception to be thrown if DispatcherPortlet is unable to determine a corresponding handler for an incoming portlet
 * request.
 *
...
public class NoHandlerFoundException extends PortletException {
	 ...
	 *
	 * @param  msg      the detail message
	 * @param  request  the current portlet request, for further context to be included in the exception message
	 */
	public NoHandlerFoundException(String msg, PortletRequest request) {
		super(msg + ": mode '" + request.getPortletMode() + "', phase '" +
