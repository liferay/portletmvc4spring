...
/**
 * {@link PortletMultipartResolver} implementation for <a href="http://commons.apache.org/proper/commons-fileupload">
 * Apache Commons FileUpload</a> 1.2 or above.
 *
 * <p>Provides "maxUploadSize", "maxInMemorySize" and "defaultEncoding" settings as bean properties (inherited from
 * {@link CommonsFileUploadSupport}). See corresponding PortletFileUpload / DiskFileItemFactory properties ("sizeMax",
 * "sizeThreshold", "headerEncoding") for details in terms of defaults and accepted values.
 *
 * <p>Saves temporary files to the portlet container's temporary directory. Needs to be initialized <i>either</i> by an
 * application context <i>or</i> via the constructor that takes a PortletContext (for standalone usage).
 *
 ...
 */
public class CommonsPortletMultipartResolver extends CommonsFileUploadSupport implements PortletMultipartResolver,
	PortletContextAware {

	private boolean resolveLazily = false;

	/**
	 * Constructor for use as bean. Determines the portlet container's temporary directory via the PortletContext passed
	 * in as through the PortletContextAware interface (typically by an ApplicationContext).
	 *
	...
	/**
	 * Constructor for standalone usage. Determines the portlet container's temporary directory via the given
	 * PortletContext.
	 *
	...
	/**
	 * Initialize the underlying {@code org.apache.commons.fileupload.portlet.PortletFileUpload} instance. Can be
