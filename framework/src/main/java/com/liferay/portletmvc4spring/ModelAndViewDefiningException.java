 ...
 *
 * <p>Can be thrown at any time during handler processing. This includes any template methods of pre-built controllers.
 * For example, a form controller might abort to a specific error page if certain parameters do not allow to proceed
...
public class ModelAndViewDefiningException extends PortletException {
	...
	/**
	 * Create new ModelAndViewDefiningException with the given ModelAndView, typically representing a specific error
	 * page.
	 *
